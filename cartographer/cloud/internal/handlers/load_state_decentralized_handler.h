...
DEFINE_HANDLER_SIGNATURE(
    LoadStateDecentralizedSignature, async_grpc::Stream<proto::LoadStateRequest>,
    proto::LoadStateResponse,
    "/cartographer.cloud.proto.MapBuilderService/LoadStateDecentralized")

class LoadStateHandler : public async_grpc::RpcHandler<LoadStateDecentralizedSignature> {
 public:
