...
#ifndef CARTOGRAPHER_CLOUD_CLIENT_MAP_BUILDER_STUB_DCEN_H_
#define CARTOGRAPHER_CLOUD_CLIENT_MAP_BUILDER_STUB_DCEN_H_
...
class MapBuilderStub : public mapping::MapBuilderInterface {
 public:
  ...
  std::map<int, int> LoadStateFromFile(const std::string& filename,
                                       bool load_frozen_state) override;
  std::map<int, int> LoadStateFromRemote(const std::string& remote_address, bool load_frozen_state);
...
#endif  // CARTOGRAPHER_CLOUD_CLIENT_MAP_BUILDER_STUB_DCEN_H_
